...
const StaffFormPage = () => {
    ...
    return (
        <MainLayout
            title={isEditMode ? t("editStaff") : t("addStaff")}
            description={isEditMode ? t("editStaffDesc") : t("addStaffDesc")}
        >
            <div className="w-full bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden animate-fade-in">
                {/* Form header chỉ chứa nút Quay lại */}
                <BackButton to="/admin/users" text={t("backToList")} />

                <form onSubmit={handleSubmit} noValidate className="p-8 grid grid-cols-12 gap-8 items-start bg-white">
                    {/* CỘT TRÁI (3/12): Xử lý Avatar (Ngang bên trái) */}
                    ...
                    <div className="col-span-12 md:col-span-9 space-y-8">
                        {/* Tab "Thông tin chi tiết" nằm trong cột phải để thẳng hàng với các field bên dưới */}
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => handleFieldChange("roleId", Number(e.target.value))}
                                            className={`w-full bg-white border rounded-xl pl-11 pr-4 py-2.5 text-sm focus:bg-white focus:ring-2 focus:ring-scholarly-primary/10 focus:border-scholarly-primary text-slate-800 font-medium outline-none transition-all duration-200 cursor-pointer ${errors.roleId ? 'border-red-500 ring-2 ring-red-500/10' : 'border-slate-200'}`}
                                        >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-5">
                                ...
                                <div className="space-y-1">
                                    <FormInput
                                        ...
                                        onChange={(e) => handleFieldChange("staffPhone", e.target.value)}
                                        hasError={!!errors.staffPhone}
                        ...
                        <div className="flex justify-end items-center gap-6 pt-6 border-t border-slate-100">
                            ...
                            >
                                {loading ? t("processing") : isEditMode ? t("editStaff") : t("addStaff")}
                            </button>
                        </div>
                    </div>
                </form>
